			...
			<div class="jumbotron">
				...
				<table align="center">
					<tr>
						...
						foreach($conn->query("SELECT * FROM ac_elementi WHERE preventivo_id = $preventivo_id") as $elemento) {
				...
				<p><a class="btn btn-md btn-success" href="#" role="button">Salva</a><a class="btn btn-md btn-warning" href="#" role="button">Cancella</a>
				</p>
			</div>
